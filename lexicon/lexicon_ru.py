LEXICON_RU: dict[str, str] = {
    ...
    'product_article': 'Артикул товара: `{dialog_data[product][id]}`',
    ...
    'product_show_image': '📷 Показать фото продукта',
    'product_show_graph': '📈 Показать график цены',
    'favorites_edit_button': '✏️ Редактировать',
    'notification_stock_true': '🔔 Товар {product} появился в продаже!',
    'notification_stock_false': '🔔 Товар {product} закончился!',
    'notification_price': '🔔 Цена на товар {product} изменилась с {old_price} руб. на {new_price} руб.!',
    'favorites_empty': 'У вас нет товаров в избранном',
    'notification_button': 'Открыть товар',
    'graph_green': 'В наличии',
    'graph_gray': 'Отсутствует',
    'cancel': '❌ Отмена',
    'close': '❌ Закрыть',
    'back': '⬅️ Назад',
    'yes': 'Да',
